...
export class MsgClientImpl {
    ...
    SendBuyOrder(request) {
        ...
        const promise = this.rpc.request('heisenberg.interchange.ibcdex.Msg', 'SendBuyOrder', data);
    ...
    SendSellOrder(request) {
        ...
        const promise = this.rpc.request('heisenberg.interchange.ibcdex.Msg', 'SendSellOrder', data);
